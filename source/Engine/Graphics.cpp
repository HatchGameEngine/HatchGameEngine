...
void Graphics::FillTriangleBlend(float x1, float y1, float x2, float y2, float x3, float y3, int c1, int c2, int c3) {
...
void Graphics::FillQuad(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4) {
    Graphics::GfxFunctions->FillQuad(x1, y1, x2, y2, x3, y3, x4, y4);
}
void Graphics::FillQuadBlend(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, int c1, int c2, int c3, int c4) {
    Graphics::GfxFunctions->FillQuadBlend(x1, y1, x2, y2, x3, y3, x4, y4, c1, c2, c3, c4);
}
void Graphics::DrawTriangleTextured(Texture* texturePtr, float x1, float y1, float x2, float y2, float x3, float y3, int c1, int c2, int c3, float u1, float v1, float u2, float v2, float u3, float v3) {
    Graphics::GfxFunctions->DrawTriangleTextured(texturePtr, x1, y1, x2, y2, x3, y3, c1, c2, c3, u1, v1, u2, v2, u3, v3);
}
void Graphics::DrawQuadTextured(Texture* texturePtr, float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, int c1, int c2, int c3, int c4, float u1, float v1, float u2, float v2, float u3, float v3, float u4, float v4) {
    Graphics::GfxFunctions->DrawQuadTextured(texturePtr, x1, y1, x2, y2, x3, y3, x4, y4, c1, c2, c3, c4, u1, v1, u2, v2, u3, v3, u4, v4);
}
