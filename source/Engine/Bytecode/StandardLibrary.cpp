...
inline ObjString * GetVMString(
	VMValue * args, int index, Uint32 threadID )
{
...
inline ObjBoundMethod * GetBoundMethod(
	VMValue * args, int index, Uint32 threadID )
{
...
inline ObjFunction * GetFunction(
	VMValue * args, int index, Uint32 threadID )
{
...
inline ObjInstance * GetInstance(
	VMValue * args, int index, Uint32 threadID )
{
...
void AddToMap( ObjMap * map, const char * key, VMValue value )
{
	...
	Uint32 hash      = map->Keys->HashFunction(
...
bool GetAnimatorSpace(
	vector<Animator *> * list, size_t * index, bool * foundEmpty )
{
	*foundEmpty = false;
	*index      = list->size( );
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	animator->Sprite =
		argCount >= 1 ? GET_ARG( 0, GetInteger ) : -1;
 ...
 * \ns Animator
 */
VMValue Animator_GetCurrentAnimation(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return INTEGER_VAL(
 ...
 * \ns Animator
 */
VMValue Animator_GetCurrentFrame(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return INTEGER_VAL(
 ...
 * \ns Animator
 */
VMValue Animator_GetPreviousAnimation(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return INTEGER_VAL(
 ...
 * \ns Animator
 */
VMValue Animator_GetAnimationSpeed(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return INTEGER_VAL(
 ...
 * \ns Animator
 */
VMValue Animator_GetAnimationTimer(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return INTEGER_VAL(
 ...
 * \ns Animator
 */
VMValue Animator_GetFrameCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return INTEGER_VAL(
 ...
 * \ns Animator
 */
VMValue Animator_GetRotationStyle(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return INTEGER_VAL(
 ...
 * \ns Animator
 */
VMValue Animator_SetCurrentAnimation(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	Scene::AnimatorList[GET_ARG( 0, GetInteger )]
 ...
 * \ns Animator
 */
VMValue Animator_SetCurrentFrame(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
 ...
 * \ns Animator
 */
VMValue Animator_SetPreviousAnimation(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
 ...
 * \ns Animator
 */
VMValue Animator_SetAnimationSpeed(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
 ...
 * \ns Animator
 */
VMValue Animator_SetAnimationTimer(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
 ...
 * \ns Animator
 */
VMValue Animator_SetFrameCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
 ...
 * \ns Animator
 */
VMValue Animator_SetRotationStyle(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
 ...
 * \ns Animator
 */
VMValue Animator_AdjustCurrentAnimation(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	Scene::AnimatorList[GET_ARG( 0, GetInteger )]
 ...
 * \ns Animator
 */
VMValue Animator_AdjustCurrentFrame(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	Scene::AnimatorList[GET_ARG( 0, GetInteger )]->CurrentFrame +=
 ...
 * \ns Animator
 */
VMValue Animator_AdjustAnimationSpeed(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	Scene::AnimatorList[GET_ARG( 0, GetInteger )]
		->AnimationSpeed += GET_ARG( 1, GetInteger );
	return NULL_VAL;
}
/***
 ...
 * \ns Animator
 */
VMValue Animator_AdjustAnimationTimer(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	Scene::AnimatorList[GET_ARG( 0, GetInteger )]
		->AnimationTimer += GET_ARG( 1, GetInteger );
	return NULL_VAL;
}
/***
 ...
 * \ns Animator
 */
VMValue Animator_AdjustDuration(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	Scene::AnimatorList[GET_ARG( 0, GetInteger )]->Duration +=
 ...
 * \ns Animator
 */
VMValue Animator_AdjustFrameCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	Scene::AnimatorList[GET_ARG( 0, GetInteger )]->FrameCount +=
 ...
 * \ns Animator
 */
VMValue Animator_AdjustLoopIndex(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	Scene::AnimatorList[GET_ARG( 0, GetInteger )]->LoopIndex +=
 ...
 * \ns Application
 */
VMValue Application_GetCommandLineArguments(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
	if( ScriptManager::Lock( ) )
	{
		ObjArray * array = NewArray( );
		for( size_t i = 0;
			i < Application::CmdLineArgs.size( );
			i++ )
		{
			array->Values->push_back(
				OBJECT_VAL( CopyString( Application::
						CmdLineArgs[i] ) ) );
		}
		ScriptManager::Unlock( );
		return OBJECT_VAL( array );
 ...
 * \ns Application
 */
VMValue Application_GetEngineVersionString(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Application
 */
VMValue Application_GetEngineVersionMajor(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Application
 */
VMValue Application_GetEngineVersionMinor(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Application
 */
VMValue Application_GetEngineVersionPatch(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Application
 */
VMValue Application_GetEngineVersionPrerelease(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Application
 */
VMValue Application_GetEngineVersionCodename(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Application
 */
VMValue Application_GetTargetFrameRate(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Application
 */
VMValue Application_SetTargetFrameRate(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Application
 */
VMValue Application_GetKeyBind(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Application
 */
VMValue Application_SetKeyBind(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int bind = GET_ARG( 0, GetInteger );
 ...
 * \ns Application
 */
VMValue Application_GetGameTitle(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Application
 */
VMValue Application_GetGameTitleShort(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Application
 */
VMValue Application_GetGameVersion(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Application
 */
VMValue Application_GetGameDescription(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Application
 */
VMValue Application_SetGameTitle(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Application
 */
VMValue Application_SetGameTitleShort(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	const char * string = GET_ARG( 0, GetString );
 ...
 * \ns Application
 */
VMValue Application_SetGameVersion(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	const char * string = GET_ARG( 0, GetString );
 ...
 * \ns Application
 */
VMValue Application_SetGameDescription(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	const char * string = GET_ARG( 0, GetString );
 ...
 * \ns Application
 */
VMValue Application_SetCursorVisible(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Application
 */
VMValue Application_GetCursorVisible(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Controller
 */
VMValue Controller_IsConnected(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	...
	return INTEGER_VAL(
		InputManager::ControllerIsConnected( index ) );
}
...
#define CONTROLLER_GET_INT( str ) \
	...
	{ \
		...
		CHECK_CONTROLLER_INDEX( index ); \
		return INTEGER_VAL( \
			(int)( InputManager::Controller##str( \
				index ) ) ); \
	}
/***
 * Controller.IsXbox
 ...
 * \ns Controller
 */
VMValue Controller_IsButtonHeld(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index  = GET_ARG( 0, GetInteger );
	...
	return INTEGER_VAL( InputManager::ControllerIsButtonHeld(
		index, button ) );
}
/***
 ...
 * \ns Controller
 */
VMValue Controller_IsButtonPressed(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index  = GET_ARG( 0, GetInteger );
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	{
		THROW_ERROR(
			"Controller axis %d out of range.", axis );
		return NULL_VAL;
	}
	return DECIMAL_VAL(
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	return ReturnString(
		InputManager::ControllerGetName( index ) );
}
/***
 ...
 * \ns Controller
 */
VMValue Controller_SetPlayerIndex(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index        = GET_ARG( 0, GetInteger );
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	if( argCount <= 3 )
	{
		...
		{
			THROW_ERROR(
				"Rumble duration %d out of range.",
				duration );
			return NULL_VAL;
		}
 ...
 * \ns Controller
 */
VMValue Controller_SetRumblePaused(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index   = GET_ARG( 0, GetInteger );
 ...
 * \ns Controller
 */
VMValue Controller_SetLargeMotorFrequency(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index       = GET_ARG( 0, GetInteger );
 ...
 * \ns Controller
 */
VMValue Controller_SetSmallMotorFrequency(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index       = GET_ARG( 0, GetInteger );
 ...
 * \ns Date
 */
VMValue Date_GetWeekday(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
	return INTEGER_VAL(
		( ( (int)time( NULL ) / 86400 ) + 3 ) % 7 );
}
/***
 * Date.GetSecond
 ...
 * \ns Directory
 */
VMValue Directory_GetDirectories(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 3 );
	ObjArray * array = NULL;
...
VMValue Draw_Animator( int argCount, VMValue * args, Uint32 threadID )
{
	...
	float scaleX =
		( argCount > 5 ) ? GET_ARG( 5, GetDecimal ) : 1.0f;
	float scaleY =
		( argCount > 6 ) ? GET_ARG( 6, GetDecimal ) : 1.0f;
	float rotation =
 ...
 * \ns Draw
 */
VMValue Draw_SetTextLineAscent(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Draw
 */
VMValue Draw_MeasureTextWrapped(
	int argCount, VMValue * args, Uint32 threadID )
{
 ...
 * \ns Draw
 */
VMValue Draw_SetBlendFactorExtended(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 4 );
 ...
 * \ns Draw
 */
VMValue Draw_SetStencilTestFunction(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Draw
 */
VMValue Draw_SetStencilPassOperation(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Draw
 */
VMValue Draw_SetStencilFailOperation(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int stencilOp = GET_ARG( 0, GetInteger );
 ...
 * \ns Draw
 */
VMValue Draw_SetHorizontalDotMask(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 1 );
 ...
 * \ns Draw
 */
VMValue Draw_SetVerticalDotMask(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 1 );
 ...
 * \ns Draw
 */
VMValue Draw_SetHorizontalDotMaskOffset(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 1 );
	SoftwareRenderer::SetDotMaskOffsetH(
 ...
 * \ns Draw
 */
VMValue Draw_SetVerticalDotMaskOffset(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 1 );
	SoftwareRenderer::SetDotMaskOffsetV(
		GET_ARG( 0, GetInteger ) );
	return NULL_VAL;
}
/***
 ...
 * \ns Draw
 */
VMValue Draw_UseStrokeSmoothing(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Draw
 */
VMValue Draw_ResetTextureTarget(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
	if( Graphics::CurrentView )
 ...
 * \ns Draw
 */
VMValue Draw_SetSpriteDeformLine(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
 ...
 * \ns Draw
 */
VMValue Draw_GetCurrentDrawGroup(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Draw3D
 */
VMValue Draw3D_BindVertexBuffer(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Draw3D
 */
VMValue Draw3D_UnbindVertexBuffer(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	Matrix4x4::Translate( &matrixScaleTranslate,
...
#define VERTEX_ARGS( num, offset ) \
	...
	{ \
		...
		data[i].Position.Y       = FP16_TO( GET_ARG( \
                        i * 3 + argOffset + 1, GetDecimal ) ); \
		data[i].Position.Z       = FP16_TO( GET_ARG( \
                        i * 3 + argOffset + 2, GetDecimal ) ); \
 ...
 * \ns Draw3D
 */
VMValue Draw3D_TriangleTextured(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 7 );
...
VMValue Ease_OutSine( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::OutSine( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InOutSine
...
VMValue Ease_InOutSine( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::InOutSine( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InQuad
...
VMValue Ease_OutQuad( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::OutQuad( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InOutQuad
...
VMValue Ease_InOutQuad( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::InOutQuad( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InCubic
...
VMValue Ease_InCubic( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::InCubic( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.OutCubic
...
VMValue Ease_OutCubic( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::OutCubic( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InOutCubic
 ...
 * \ns Ease
 */
VMValue Ease_InOutCubic(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::InOutCubic( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InQuart
...
VMValue Ease_InQuart( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::InQuart( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.OutQuart
...
VMValue Ease_OutQuart( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::OutQuart( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InOutQuart
 ...
 * \ns Ease
 */
VMValue Ease_InOutQuart(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::InOutQuart( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InQuint
...
VMValue Ease_InQuint( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::InQuint( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.OutQuint
...
VMValue Ease_OutQuint( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::OutQuint( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InOutQuint
 ...
 * \ns Ease
 */
VMValue Ease_InOutQuint(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::InOutQuint( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InExpo
...
VMValue Ease_OutExpo( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::OutExpo( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InOutExpo
...
VMValue Ease_InOutExpo( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::InOutExpo( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InCirc
...
VMValue Ease_OutCirc( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::OutCirc( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InOutCirc
...
VMValue Ease_InOutCirc( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::InOutCirc( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InBack
...
VMValue Ease_OutBack( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::OutBack( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InOutBack
...
VMValue Ease_InOutBack( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::InOutBack( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InElastic
...
VMValue Ease_InElastic( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::InElastic( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.OutElastic
 ...
 * \ns Ease
 */
VMValue Ease_OutElastic(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::OutElastic( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InOutElastic
 ...
 * \ns Ease
 */
VMValue Ease_InOutElastic(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::InOutElastic( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InBounce
...
VMValue Ease_InBounce( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::InBounce( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.OutBounce
...
VMValue Ease_OutBounce( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::OutBounce( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.InOutBounce
 ...
 * \ns Ease
 */
VMValue Ease_InOutBounce(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::InOutBounce( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Ease.Triangle
...
VMValue Ease_Triangle( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Ease::Triangle( GET_ARG( 0, GetDecimal ) ) );
}
// #endregion
...
// #region Geometry
static vector<FVector2> GetPolygonPoints(
	ObjArray * array, const char * arrName, int threadID )
{
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	int booleanOp       = GET_ARG_OPT(
                2, GetInteger, GeoBooleanOp_Intersection );
	int fillRule =
		GET_ARG_OPT( 3, GetInteger, GeoFillRule_EvenOdd );
	...
	for( unsigned i = 0; i < subjects->Values->size( ); i++ )
	{
		...
		Polygon2D subject( GetPolygonPoints( AS_ARRAY( value ),
			"subject array",
			threadID ) );
 ...
 * \ns Geometry
 */
VMValue Geometry_IsPointInsidePolygon(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 3 );
 ...
 * \ns Geometry
 */
VMValue Geometry_IsLineIntersectingPolygon(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 5 );
 ...
 * \ns Input
 */
VMValue Input_IsMouseButtonDown(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Input
 */
VMValue Input_IsMouseButtonPressed(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int button = GET_ARG( 0, GetInteger );
	return INTEGER_VAL(
		( InputManager::MousePressed >> button ) & 1 );
}
/***
 ...
 * \ns Input
 */
VMValue Input_IsMouseButtonReleased(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int button = GET_ARG( 0, GetInteger );
 ...
 * \ns Input
 */
VMValue Input_IsActionReleased(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 2 );
	int playerID      = GET_ARG( 0, GetInteger );
 ...
 * \ns Input
 */
VMValue Input_IsAnyActionPressed(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 1 );
	int playerID = GET_ARG( 0, GetInteger );
 ...
 * \ns Input
 */
VMValue Input_IsAnyActionReleased(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 1 );
	int playerID = GET_ARG( 0, GetInteger );
	...
	if( argCount >= 2 )
	{
		...
		CHECK_INPUT_DEVICE( inputDevice );
		return INTEGER_VAL(
			!!InputManager::IsAnyActionReleased(
				playerID, inputDevice ) );
	}
	else
		return INTEGER_VAL(
 ...
 * \ns Input
 */
VMValue Input_GetAnalogActionInput(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 2 );
	int playerID      = GET_ARG( 0, GetInteger );
...
static KeyboardBind * GetKeyboardActionBind(
	ObjMap * map, Uint32 threadID )
{
...
static ControllerButtonBind * GetControllerButtonActionBind(
	ObjMap * map, Uint32 threadID )
{
...
static ControllerAxisBind * GetControllerAxisActionBind(
	ObjMap * map, Uint32 threadID )
{
 ...
 * \ns Input
 */
VMValue Input_RemoveActionBind(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 2 );
	int playerID      = GET_ARG( 0, GetInteger );
...
static ObjArray * GetBoundActionList(
	int playerID, int actionID, bool isDefault )
{
	ObjArray * array = NewArray( );
 ...
 * \ns Input
 */
VMValue Input_GetBoundActionList(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int playerID      = GET_ARG( 0, GetInteger );
 ...
 * \ns Input
 */
VMValue Input_GetBoundActionCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 2 );
	int playerID      = GET_ARG( 0, GetInteger );
 ...
 * \ns Input
 */
VMValue Input_GetBoundActionMap(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int playerID = GET_ARG( 0, GetInteger );
 ...
 * \ns Input
 */
VMValue Input_GetDefaultActionBind(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 2 );
	int playerID      = GET_ARG( 0, GetInteger );
 ...
 * \ns Input
 */
VMValue Input_SetDefaultActionBind(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 4 );
	int playerID      = GET_ARG( 0, GetInteger );
 ...
 * \ns Input
 */
VMValue Input_AddDefaultActionBind(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 4 );
	int playerID      = GET_ARG( 0, GetInteger );
 ...
 * \ns Input
 */
VMValue Input_RemoveDefaultActionBind(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 2 );
	int playerID      = GET_ARG( 0, GetInteger );
 ...
 * \ns Input
 */
VMValue Input_GetDefaultBoundActionList(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int playerID      = GET_ARG( 0, GetInteger );
 ...
 * \ns Input
 */
VMValue Input_GetDefaultBoundActionCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 2 );
	int playerID      = GET_ARG( 0, GetInteger );
 ...
 * \ns Input
 */
VMValue Input_GetDefaultBoundActionMap(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int playerID = GET_ARG( 0, GetInteger );
 ...
 * \ns Input
 */
VMValue Input_ResetActionBindsToDefaults(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int playerID = GET_ARG( 0, GetInteger );
 ...
 * \ns Input
 */
VMValue Input_IsPlayerUsingDevice(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int playerID    = GET_ARG( 0, GetInteger );
 ...
 * \ns Input
 */
VMValue Input_GetPlayerControllerIndex(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int playerID = GET_ARG( 0, GetInteger );
 ...
 * \ns Input
 */
VMValue Input_SetPlayerControllerIndex(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int playerID     = GET_ARG( 0, GetInteger );
	...
	CHECK_INPUT_PLAYER_INDEX( playerID );
	InputManager::SetPlayerControllerIndex(
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	ObjectList * objectList =
		Scene::ObjectLists->Get( objectName );
	ScriptEntity * object =
		(ScriptEntity *)objectList->GetNth( n );
 ...
 * \ns Instance
 */
VMValue Instance_GetNextInstance(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
 ...
 * \ns Instance
 */
VMValue Instance_DisableAutoAnimate(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
...
static int JSON_FillArray(
	ObjArray *, const char *, jsmntok_t *, size_t );

static int JSON_FillMap(
	ObjMap * map, const char * text, jsmntok_t * t, size_t count )
{
	jsmntok_t * key;
	jsmntok_t * value;
	if( count == 0 )
...
VMValue Math_Clamp( int argCount, VMValue * args, Uint32 threadID )
{
	...
	if( IS_INTEGER( args[0] ) && IS_INTEGER( args[1] ) &&
		...
		return DECIMAL_VAL(
			Math::Clamp( GET_ARG( 0, GetDecimal ),
				GET_ARG( 1, GetDecimal ),
				GET_ARG( 2, GetDecimal ) ) );
}
/***
...
VMValue Math_RandomMax( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return DECIMAL_VAL(
		Math::RandomMax( GET_ARG( 0, GetDecimal ) ) );
}
/***
 * Math.RandomRange
 ...
 * \ns RSDK.Math
 */
VMValue Math_RandomIntegerSeeded(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 2 );
	if( argCount < 3 )
 ...
 * \ns RSDK.Math
 */
VMValue Math_ClearTrigLookupTables(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns RSDK.Math
 */
VMValue Math_CalculateTrigAngles(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
...
VMValue Math_Sin1024( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return INTEGER_VAL(
		Math::Sin1024( GET_ARG( 0, GetInteger ) ) );
}
/***
 * RSDK.Math.Cos1024
...
VMValue Math_Cos1024( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return INTEGER_VAL(
		Math::Cos1024( GET_ARG( 0, GetInteger ) ) );
}
/***
 * RSDK.Math.Tan1024
...
VMValue Math_Tan1024( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return INTEGER_VAL(
		Math::Tan1024( GET_ARG( 0, GetInteger ) ) );
}
/***
 * RSDK.Math.ASin1024
...
VMValue Math_ASin1024( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return INTEGER_VAL(
		Math::ASin1024( GET_ARG( 0, GetInteger ) ) );
}
/***
 * RSDK.Math.ACos1024
...
VMValue Math_ACos1024( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return INTEGER_VAL(
		Math::ACos1024( GET_ARG( 0, GetInteger ) ) );
}
/**
 * RSDK.Math.Sin512
...
VMValue Math_ASin512( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return INTEGER_VAL(
		Math::ASin512( GET_ARG( 0, GetInteger ) ) );
}
/***
 * RSDK.Math.ACos512
...
VMValue Math_ACos512( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return INTEGER_VAL(
		Math::ACos512( GET_ARG( 0, GetInteger ) ) );
}
/**
 * RSDK.Math.Sin256
...
VMValue Math_ASin256( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return INTEGER_VAL(
		Math::ASin256( GET_ARG( 0, GetInteger ) ) );
}
/***
 * RSDK.Math.ACos256
...
VMValue Math_ACos256( int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return INTEGER_VAL(
		Math::ACos256( GET_ARG( 0, GetInteger ) ) );
}
/***
 ...
 * \ns RSDK.Math
 */
VMValue Math_RadianToInteger(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	return INTEGER_VAL( (int)( (float)GET_ARG( 0, GetDecimal ) *
		256.0 / M_PI ) );
}
/***
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	for( int i = 0; i < 16; i++ )
		( *array->Values )[i] =
			DECIMAL_VAL( matrix4x4.Values[i] );
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	helper[0][2] =
		( sineZ * ( cosineY * cosineX / 256.0 ) / 256.0 ) -
 ...
 * \ns Model
 */
VMValue Model_GetAnimationCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	IModel * model = GET_ARG( 0, GetModel );
 ...
 * \ns Model
 */
VMValue Model_GetAnimationName(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	...
	const char * animationName =
		model->Animations[animation]->Name;
	if( !animationName )
		return NULL_VAL;
 ...
 * \ns Model
 */
VMValue Model_GetAnimationIndex(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	IModel * model = GET_ARG( 0, GetModel );
	...
	return INTEGER_VAL(
		model->GetAnimationIndex( animationName ) );
}
/***
 * Model.GetFrameCount
 ...
 * \ns Model
 */
VMValue Model_GetAnimationLength(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	IModel * model = GET_ARG( 0, GetModel );
	...
	CHECK_MODEL_ANIMATION_INDEX( animation );
	return INTEGER_VAL(
		(int)model->Animations[animation]->Length );
}
/***
 * Model.HasMaterials
 ...
 * \ns Model
 */
VMValue Model_GetMaterialCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	IModel * model = GET_ARG( 0, GetModel );
 ...
 * \ns Palette
 */
VMValue Palette_EnablePaletteUsage(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Palette
 */
VMValue Palette_LoadFromResource(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 2 );
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	CHECK_COLOR_INDEX( colorIndex );
	Uint32 * color =
		&Graphics::PaletteColors[palIndex][colorIndex];
 ...
 * \ns Palette
 */
VMValue Palette_GetColorTransparent(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int palIndex   = GET_ARG( 0, GetInteger );
 ...
 * \ns Palette
 */
VMValue Palette_SetColorTransparent(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 3 );
	int palIndex       = GET_ARG( 0, GetInteger );
 ...
 * \ns Palette
 */
inline Uint32 PMP_ColorBlend(
	Uint32 color1, Uint32 color2, int percent )
{
 ...
 * \ns Palette
 */
VMValue Palette_RotateColorsLeft(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 3 );
	int palIndex        = GET_ARG( 0, GetInteger );
 ...
 * \ns Palette
 */
VMValue Palette_RotateColorsRight(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 3 );
	int palIndex        = GET_ARG( 0, GetInteger );
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	memcpy( &Graphics::PaletteColors[palIndexTo]
					[colorIndexStartTo],
 ...
 * \ns Palette
 */
VMValue Palette_UsePaletteIndexLines(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Palette
 */
VMValue Palette_SetPaletteIndexLines(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 3 );
	int palIndex     = GET_ARG( 0, GetInteger );
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	int result =
		Scene::LoadSpriteResource( filename, unloadPolicy );
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	int result =
		Scene::LoadImageResource( filename, unloadPolicy );
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	int result =
		Scene::LoadModelResource( filename, unloadPolicy );
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	int result =
		Scene::LoadMusicResource( filename, unloadPolicy );
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	int result =
		Scene::LoadSoundResource( filename, unloadPolicy );
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	int result =
		Scene::LoadVideoResource( filename, unloadPolicy );
 ...
 * \ns Scene
 */
VMValue Scene_ProcessObjectMovement(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 3 );
	...
	if( entity && outer && inner )
	{
		...
		outerBox.Left =
			(int)AS_DECIMAL( ( *outer->Values )[0] );
		outerBox.Top =
			(int)AS_DECIMAL( ( *outer->Values )[1] );
		outerBox.Right =
			(int)AS_DECIMAL( ( *outer->Values )[2] );
		outerBox.Bottom =
			(int)AS_DECIMAL( ( *outer->Values )[3] );

		innerBox.Left =
			(int)AS_DECIMAL( ( *inner->Values )[0] );
		innerBox.Top =
			(int)AS_DECIMAL( ( *inner->Values )[1] );
		innerBox.Right =
			(int)AS_DECIMAL( ( *inner->Values )[2] );
		innerBox.Bottom =
			(int)AS_DECIMAL( ( *inner->Values )[3] );
		Scene::ProcessObjectMovement(
 ...
 * \ns Scene
 */
VMValue Scene_ObjectTileCollision(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 7 );
	ObjInstance * entity = GET_ARG( 0, GetInstance );
 ...
 * \ns Scene
 */
VMValue Scene_CheckObjectCollisionTouch(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 4 );
	...
	{
		thisBox.Left =
			AS_INTEGER( ( *thisHitbox->Values )[0] );
		thisBox.Top = AS_INTEGER( ( *thisHitbox->Values )[1] );
		thisBox.Right =
			AS_INTEGER( ( *thisHitbox->Values )[2] );
		thisBox.Bottom =
			AS_INTEGER( ( *thisHitbox->Values )[3] );
	}
	else
	{
		thisBox.Left =
	...
	{
		otherBox.Left =
			AS_INTEGER( ( *otherHitbox->Values )[0] );
		otherBox.Top =
			AS_INTEGER( ( *otherHitbox->Values )[1] );
		otherBox.Right =
			AS_INTEGER( ( *otherHitbox->Values )[2] );
		otherBox.Bottom =
 ...
 * \ns Scene
 */
VMValue Scene_CheckObjectCollisionCircle(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 4 );
	ObjInstance * thisEntity  = GET_ARG( 0, GetInstance );
 ...
 * \ns Scene
 */
VMValue Scene_CheckObjectCollisionBox(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 5 );
	ObjInstance * thisEntity  = GET_ARG( 0, GetInstance );
 ...
 * \ns Scene
 */
VMValue Scene_CheckObjectCollisionPlatform(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 5 );
	ObjInstance * thisEntity  = GET_ARG( 0, GetInstance );
 ...
 * \ns Scene
 */
VMValue Scene_LoadNoPersistency(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	char * filename = GET_ARG( 0, GetString );
 ...
 * \ns Scene
 */
VMValue Scene_LoadTileCollisions(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 1 );
	char * filename = GET_ARG( 0, GetString );
 ...
 * \ns Scene
 */
VMValue Scene_AreTileCollisionsLoaded(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Scene
 */
VMValue Scene_GetLayerUsePaletteIndexLines(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int index = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_GetLayerProperty(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index       = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_GetLayerDeformSplitLine(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int index = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_GetLayerDeformOffsetA(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int index = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_GetLayerDeformOffsetB(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int index = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_LayerPropertyExists(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index       = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_GetLayerDrawGroup(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int index = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_GetLayerHorizontalRepeat(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Scene
 */
VMValue Scene_GetLayerVerticalRepeat(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Scene
 */
VMValue Scene_GetTilesetTileCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int index = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_GetTilesetFirstTileID(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int index = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_GetTilesetPaletteIndex(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int index = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_GetDrawGroupCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Scene
 */
VMValue Scene_GetDrawGroupEntityDepthSorting(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Scene
 */
VMValue Scene_GetCurrentFolder(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Scene
 */
VMValue Scene_GetCurrentResourceFolder(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Scene
 */
VMValue Scene_GetCurrentSpriteFolder(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
	return ReturnString( Scene::CurrentResourceFolder );
 ...
 * \ns Scene
 */
VMValue Scene_GetCurrentCategory(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Scene
 */
VMValue Scene_GetActiveCategory(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Scene
 */
VMValue Scene_GetCategoryCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Scene
 */
VMValue Scene_GetFirstInstance(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Scene
 */
VMValue Scene_GetInstanceCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Scene
 */
VMValue Scene_GetStaticInstanceCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Scene
 */
VMValue Scene_GetDynamicInstanceCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
 ...
 * \ns Scene
 */
VMValue Scene_GetTileAnimationEnabled(
	int argCount, VMValue * args, Uint32 threadID )
{
 ...
 * \ns Scene
 */
VMValue Scene_GetTileAnimSequence(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Scene
 */
VMValue Scene_GetTileAnimSequenceDurations(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int tileID = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_GetTileAnimSequencePaused(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int tileID = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_GetTileAnimSequenceSpeed(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int tileID = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_GetTileAnimSequenceFrame(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int tileID = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_IsCurrentEntryValid(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
	if( SceneInfo::IsEntryValid( Scene::ActiveCategory,
 ...
 * \ns Scene
 */
VMValue Scene_CheckSceneFolder(
	int argCount, VMValue * args, Uint32 threadID )
{
 ...
 * \ns Scene
 */
VMValue Scene_SetActiveCategory(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Scene
 */
VMValue Scene_SetTileCollisionSides(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 5 );
	int layer = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetTileAnimationEnabled(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Scene
 */
VMValue Scene_SetTileAnimSequence(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 2 );
 ...
 * \ns Scene
 */
VMValue Scene_SetTileAnimSequenceFromSprite(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 3 );
 ...
 * \ns Scene
 */
VMValue Scene_SetTileAnimSequencePaused(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int tileID    = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetTileAnimSequenceSpeed(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int tileID  = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetTileAnimSequenceFrame(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int tileID     = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetTilesetPaletteIndex(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index    = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetLayerCollidable(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index   = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetLayerInternalSize(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 3 );
	int index = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetLayerOffsetPosition(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 3 );
	int index   = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetLayerDrawGroup(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetLayerDrawBehavior(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index        = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetLayerHorizontalRepeat(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index       = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetLayerVerticalRepeat(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index       = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetDrawGroupCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Scene
 */
VMValue Scene_SetDrawGroupEntityDepthSorting(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int drawg = GET_ARG( 0, GetInteger ) % Scene::PriorityPerLayer;
 ...
 * \ns Scene
 */
VMValue Scene_SetLayerUsePaletteIndexLines(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index                = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetLayerSetParallaxLinesBegin(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int index = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetLayerSetParallaxLines(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 5 );
 ...
 * \ns Scene
 */
VMValue Scene_SetLayerSetParallaxLinesEnd(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
	if( !BufferedScrollLines )
	...
	{
		THROW_ERROR(
			"Invalid layer set in scroll line setup." );
		return NULL_VAL;
	}
 ...
 * \ns Scene
 */
VMValue Scene_SetLayerTileDeforms(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 4 );
	int index     = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetLayerTileDeformSplitLine(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index          = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetLayerTileDeformOffsets(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 3 );
	int index         = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetLayerDeformOffsetA(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index   = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetLayerDeformOffsetB(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index   = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetLayerCustomScanlineFunction(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index = GET_ARG( 0, GetInteger );
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	scanLine->SrcX =
		(Sint64)( GET_ARG( 1, GetDecimal ) * 0x10000 );
	scanLine->SrcY =
		(Sint64)( GET_ARG( 2, GetDecimal ) * 0x10000 );
	scanLine->DeltaX =
		(Sint64)( GET_ARG( 3, GetDecimal ) * 0x10000 );
	scanLine->DeltaY =
		(Sint64)( GET_ARG( 4, GetDecimal ) * 0x10000 );
 ...
 * \ns Scene
 */
VMValue Scene_SetLayerCustomRenderFunction(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int index = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetObjectViewRender(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int view_index = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene
 */
VMValue Scene_SetTileViewRender(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int view_index = GET_ARG( 0, GetInteger );
 ...
 * \ns SceneList
 */
VMValue SceneList_GetCategoryID(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	char * categoryName = GET_ARG( 0, GetString );
 ...
 * \ns SceneList
 */
VMValue SceneList_GetEntryName(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
 ...
 * \ns SceneList
 */
VMValue SceneList_GetCategoryName(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns SceneList
 */
VMValue SceneList_GetEntryProperty(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 3 );
 ...
 * \ns SceneList
 */
VMValue SceneList_GetCategoryProperty(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
 ...
 * \ns SceneList
 */
VMValue SceneList_HasEntryProperty(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 3 );
 ...
 * \ns SceneList
 */
VMValue SceneList_HasCategoryProperty(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
 ...
 * \ns SceneList
 */
VMValue SceneList_GetCategoryCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
	return INTEGER_VAL( (int)SceneInfo::Categories.size( ) );
 ...
 * \ns SceneList
 */
VMValue SceneList_GetSceneCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 0 );
	if( argCount >= 1 )
 ...
 * \ns Scene3D
 */
VMValue Scene3D_SetFaceCullMode(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	Uint32 scene3DIndex = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene3D
 */
VMValue Scene3D_SetFieldOfView(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	Uint32 scene3DIndex = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene3D
 */
VMValue Scene3D_SetFarClippingPlane(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	Uint32 scene3DIndex    = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene3D
 */
VMValue Scene3D_SetNearClippingPlane(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	Uint32 scene3DIndex     = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene3D
 */
VMValue Scene3D_SetCustomProjectionMatrix(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	Uint32 scene3DIndex = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene3D
 */
VMValue Scene3D_SetAmbientLighting(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 4 );
	Uint32 scene3DIndex = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene3D
 */
VMValue Scene3D_SetDiffuseLighting(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 4 );
	Uint32 scene3DIndex = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene3D
 */
VMValue Scene3D_SetSpecularLighting(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 4 );
	Uint32 scene3DIndex = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene3D
 */
VMValue Scene3D_SetFogEquation(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	Uint32 scene3DIndex = GET_ARG( 0, GetInteger );
 ...
 * \ns Scene3D
 */
VMValue Scene3D_SetFogSmoothness(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	Uint32 scene3DIndex = GET_ARG( 0, GetInteger );
 ...
 * \ns Serializer
 */
VMValue Serializer_WriteToStream(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
 ...
 * \ns Serializer
 */
VMValue Serializer_ReadFromStream(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	ObjStream * stream = GET_ARG( 0, GetStream );
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	Application::Settings->SetString( section,
		GET_ARG( 1, GetString ),
		GET_ARG( 2, GetString ) );
	return NULL_VAL;
}
 ...
 * \ns Settings
 */
VMValue Settings_RemoveSection(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Settings
 */
VMValue Settings_SectionExists(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns Settings
 */
VMValue Settings_GetSectionCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
	return INTEGER_VAL(
		Application::Settings->GetSectionCount( ) );
}
/***
 ...
 * \ns Settings
 */
VMValue Settings_PropertyExists(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
 ...
 * \ns Settings
 */
VMValue Settings_RemoveProperty(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
 ...
 * \ns Settings
 */
VMValue Settings_GetPropertyCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns SocketClient
 */
VMValue SocketClient_BytesToRead(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
	if( !client )
 ...
 * \ns SocketClient
 */
VMValue SocketClient_ReadDecimal(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
	if( !client )
 ...
 * \ns SocketClient
 */
VMValue SocketClient_ReadInteger(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
	if( !client )
 ...
 * \ns SocketClient
 */
VMValue SocketClient_ReadString(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
	if( !client )
 ...
 * \ns SocketClient
 */
VMValue SocketClient_WriteDecimal(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
 ...
 * \ns SocketClient
 */
VMValue SocketClient_WriteInteger(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int value = GET_ARG( 0, GetInteger );
 ...
 * \ns SocketClient
 */
VMValue SocketClient_WriteString(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
...
#define CHECK_ANIMFRAME_INDEX( anim, idx ) \
	...
	{ \
		OUT_OF_RANGE_ERROR( "Frame index", \
			idx, \
			0, \
			sprite->Animations[anim].Frames.size( ) - \
				1 ); \
		return NULL_VAL; \
	}
/***
 ...
 * \ns Sprite
 */
VMValue Sprite_GetAnimationCount(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	ISprite * sprite = GET_ARG( 0, GetSprite );
 ...
 * \ns Sprite
 */
VMValue Sprite_GetAnimationName(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	ISprite * sprite = GET_ARG( 0, GetSprite );
 ...
 * \ns Sprite
 */
VMValue Sprite_GetAnimationIndexByName(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	ISprite * sprite = GET_ARG( 0, GetSprite );
 ...
 * \ns Sprite
 */
VMValue Sprite_GetFrameLoopIndex(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	ISprite * sprite = GET_ARG( 0, GetSprite );
	...
	return INTEGER_VAL(
		sprite->Animations[animation].FrameToLoop );
}
/***
 ...
 * \ns Sprite
 */
VMValue Sprite_GetFrameDuration(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 3 );
	ISprite * sprite = GET_ARG( 0, GetSprite );
 ...
 * \ns Sprite
 */
VMValue Sprite_GetFrameOffsetX(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 3 );
	ISprite * sprite = GET_ARG( 0, GetSprite );
 ...
 * \ns Sprite
 */
VMValue Sprite_GetFrameOffsetY(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 3 );
	ISprite * sprite = GET_ARG( 0, GetSprite );
 ...
 * \ns Sprite
 */
VMValue Sprite_MakeNonPalettized(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	ISprite * sprite = GET_ARG( 0, GetSprite );
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	if( ScriptManager::Lock( ) )
	{
		...
		ObjStream * stream = NewStream( streamPtr,
			access == FileStream::WRITE_ACCESS );
		ScriptManager::Unlock( );
		return OBJECT_VAL( stream );
	}
	return NULL_VAL;
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	{
		obj = OBJECT_VAL(
			CopyString( string + index, length ) );
		ScriptManager::Unlock( );
	}
	return obj;
}
 ...
 * \ns Touch
 */
VMValue Touch_IsPressed(
	int argCount, VMValue * args, Uint32 threadID )
{
	int touch_index = GET_ARG( 0, GetInteger );
	return INTEGER_VAL(
		InputManager::TouchIsPressed( touch_index ) );
}
/***
 * Touch.IsReleased
 ...
 * \ns Touch
 */
VMValue Touch_IsReleased(
	int argCount, VMValue * args, Uint32 threadID )
{
	int touch_index = GET_ARG( 0, GetInteger );
	return INTEGER_VAL(
		InputManager::TouchIsReleased( touch_index ) );
}
// #endregion
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	// 15, or 0b1111
	return INTEGER_VAL(
		Scene::CollisionAt( x, y, 0, 15, NULL ) >= 0 );
}
/***
 ...
 * \ns TileCollision
 */
VMValue TileCollision_PointExtended(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 4 );
	int x = (int)std::floor( GET_ARG( 0, GetDecimal ) );
 ...
 * \ns TileInfo
 */
VMValue TileInfo_SetSpriteInfo(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 4 );
	int tileID         = GET_ARG( 0, GetInteger );
 ...
 * \ns TileInfo
 */
VMValue TileInfo_GetBehaviorFlag(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int tileID         = GET_ARG( 0, GetInteger );
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	// SDL_DetachThread
	SDL_CreateThread(
		_Thread_RunEvent, "_Thread_RunEvent", bundle );
 ...
 * \ns Video
 */
VMValue Video_SetBufferDuration(
	int argCount, VMValue * args, Uint32 threadID )
{
	return NULL_VAL;
}
 ...
 * \ns Video
 */
VMValue Video_GetBufferDuration(
	int argCount, VMValue * args, Uint32 threadID )
{
	return NULL_VAL;
}
...
#ifdef USING_FFMPEG
	return DECIMAL_VAL(
		(float)video->Player->GetBufferPosition( ) );
#endif
	return NULL_VAL;
}
/***
 ...
 * \ns Video
 */
VMValue Video_GetTrackLanguage(
	int argCount, VMValue * args, Uint32 threadID )
{
	return NULL_VAL;
}
 ...
 * \ns Video
 */
VMValue Video_GetDefaultVideoTrack(
	int argCount, VMValue * args, Uint32 threadID )
{
	return NULL_VAL;
}
 ...
 * \ns Video
 */
VMValue Video_GetDefaultAudioTrack(
	int argCount, VMValue * args, Uint32 threadID )
{
	return NULL_VAL;
}
 ...
 * \ns Video
 */
VMValue Video_GetDefaultSubtitleTrack(
	int argCount, VMValue * args, Uint32 threadID )
{
	return NULL_VAL;
}
 ...
 * \ns View
 */
VMValue View_SetOutputPosition(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_AT_LEAST_ARGCOUNT( 3 );
	int view_index = GET_ARG( 0, GetInteger );
 ...
 * \ns View
 */
VMValue View_IsUsingDrawTarget(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int view_index = GET_ARG( 0, GetInteger );
 ...
 * \ns View
 */
VMValue View_IsUsingSoftwareRenderer(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 1 );
	int view_index = GET_ARG( 0, GetInteger );
 ...
 * \ns View
 */
VMValue View_SetUseSoftwareRenderer(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 2 );
	int view_index = GET_ARG( 0, GetInteger );
 ...
 * \ns View
 */
VMValue View_SetUsePerspective(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 4 );
	int view_index  = GET_ARG( 0, GetInteger );
	...
	int argCount, VMValue * args, Uint32 threadID )
{
	...
	return INTEGER_VAL( Scene::CheckPosOnScreen(
		selfX, selfY, rangeX, rangeY ) );
}
/***
 ...
 * \ns Window
 */
VMValue Window_SetPositionCentered(
	int argCount, VMValue * args, Uint32 threadID )
{
	CHECK_ARGCOUNT( 0 );
	SDL_SetWindowPosition( Application::Window,
...
static VMValue XML_FillMap( XMLNode * parent )
{
		...
		!parent->children[0]->children.size( ) )
	{
		...
		if( numAttr )
		{
			...
			keyHash =
				map->Keys->HashFunction( textKey, 5 );
	...
	for( size_t i = 0; i < numAttr; i++ )
	{
		...
		{
			attrNameSize = length;
			attrName     = (char *)realloc(
                                attrName, attrNameSize );
			if( !attrName )
			{
				Log::Print( Log::LOG_ERROR,
...
#define DEF_LINK_INT( a, b ) \
	ScriptManager::GlobalLinkInteger( NULL, a, b )
...
{
	ObjClass * klass =
		NewClass( Murmur::EncryptString( className ) );
...
{
	ObjNamespace * ns =
		NewNamespace( Murmur::EncryptString( nsName ) );
...
#define DEF_NAMESPACED_NATIVE( className, funcName ) \
	 ...
	 */
	DEF_CONST_INT(
		"NUM_CONTROLLER_AXES", (int)ControllerAxis::Max );
...
#undef CONST_CONTROLLER
	 ...
	 */
	DEF_CONST_INT(
		"NUM_INPUT_DEVICE_TYPES", (int)InputDevice_MAX );
