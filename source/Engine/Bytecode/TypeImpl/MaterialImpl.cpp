...
void MaterialImpl::Init( )
{
	...
	Hash_DiffuseTexture =
		Murmur::EncryptString( "DiffuseTexture" );
	...
	Hash_AmbientTexture =
		Murmur::EncryptString( "AmbientTexture" );
...
VMValue MaterialImpl::VM_Initializer(
...
bool MaterialImpl::VM_PropertyGet(
...
static void DoTextureReplacement(
	int imageID, Image ** image, Uint32 threadID )
{
...
bool MaterialImpl::VM_PropertySet(
