...
Image * Material::TryLoadForModel(
	std::string imagePath, const char * parentDirectory )
{
...
Image * Material::LoadForModel(
	string imagePath, const char * parentDirectory )
{
...
Image * Material::LoadForModel(
	const char * imagePath, const char * parentDirectory )
{
	return LoadForModel(
		std::string( imagePath ), parentDirectory );
}
