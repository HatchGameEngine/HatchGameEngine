...
#define SHADER_FEATURE_DOT_PATTERN_X (1 << 12)
#define SHADER_FEATURE_DOT_PATTERN_Y (1 << 13)

#define NUM_SHADER_FEATURES 14
...
#define SHADER_FEATURE_DOT_PATTERN_FLAGS (SHADER_FEATURE_DOT_PATTERN_X | SHADER_FEATURE_DOT_PATTERN_Y)
