...
Sint64 Vector::IntersectWithPlane(
	Vector4 plane, Vector4 normal, Vector4 v1, Vector4 v2 )
{
	Vector4 planeNormal = Vector::Normalize( normal );
	Sint64 dotProduct   = Vector::DotProduct( v1, planeNormal );
	Sint64 t =
		Vector::DotProduct( planeNormal, plane ) - dotProduct;
	Sint64 diff =
		Vector::DotProduct( v2, planeNormal ) - dotProduct;
	if( diff == 0 )
		return 0;
...
Sint64 Vector::DistanceToPlane(
	Vector4 v, Vector4 plane, Vector4 normal )
{
