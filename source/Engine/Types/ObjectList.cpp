...
Entity * ObjectList::Spawn( ) { return SpawnFunction( this ); }
...
void ObjectList::RemoveNonPersistentFromLinkedList(
...
void ObjectList::ResetPerf( ) { Performance.Clear( ); }
...
int ObjectList::Count( ) { return EntityCount; }
