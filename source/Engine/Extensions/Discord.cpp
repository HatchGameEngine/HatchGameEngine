...
void Discord::UpdatePresence(char* details, char* state, char* image_key, int party_size, int party_max) {
    Discord::UpdatePresence(details, state, image_key, party_size, party_max, 0);
}
void Discord::UpdatePresence(char* details, char* state, char* image_key, int party_size, int party_max, time_t start_time) {
