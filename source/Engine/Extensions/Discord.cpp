...
void ( *_Discord_Initialize )( const char *,
	...
	int,
	const char * ) = NULL;
void ( *_Discord_UpdatePresence )(
	const DiscordRichPresence * )    = NULL;
...
void Discord::Init(
	const char * application_id, const char * steam_id )
{
	...
	_Discord_Initialize     = (void ( * )( const char *,
                DiscordEventHandlers *,
                int,
                const char * ))SDL_LoadFunction( library,
                "Discord_Initialize" );
	_Discord_UpdatePresence = (void ( * )(
		const DiscordRichPresence * ))
		SDL_LoadFunction( library, "Discord_UpdatePresence" );
...
void Discord::UpdatePresence(
	char * details, char * state, char * image_key )
{
