...
int SoundFormat::LoadSamples( size_t count ) { return 0; }
int SoundFormat::GetSamples(
	Uint8 * buffer, size_t count, Sint32 loopIndex )
{
...
size_t SoundFormat::TellSample( ) { return SampleIndex; }
