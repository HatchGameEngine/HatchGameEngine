...
size_t OGG::StaticRead(
	void * mem, size_t size, size_t nmemb, void * ptr )
{
...
Sint32 OGG::StaticCloseFree( void * ptr ) { return 0; }
Sint32 OGG::StaticCloseNoFree( void * ptr ) { return 0; }
...
void OGG::LoadAllSamples( )
{
	...
	if( Samples.size( ) < TotalPossibleSamples )
	{
		...
		SeekSample( 0 );
		size_t readSamples =
			LoadSamples( TotalPossibleSamples );
