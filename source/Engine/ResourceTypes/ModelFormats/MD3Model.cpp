...
void MD3Model::DecodeNormal(
	Uint16 index, float & x, float & y, float & z )
{
...
void MD3Model::ReadUVs(
	Vector2 * uvs, Sint32 vertexCount, Stream * stream )
{
	for( Sint32 i = 0; i < vertexCount; i++ )
	{
...
void MD3Model::ReadVertexIndices(
	Sint32 * indices, Sint32 triangleCount, Stream * stream )
{
...
Mesh * MD3Model::ReadSurface(
	IModel * model, Stream * stream, size_t surfaceDataOffset )
{
