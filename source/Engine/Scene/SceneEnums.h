...
enum {
	...
	TILESIDE_TOP_BOTTOM = TILESIDE_TOP | TILESIDE_BOTTOM,
	TILESIDE_LEFT_RIGHT = TILESIDE_LEFT | TILESIDE_RIGHT,
	TILESIDE_LEFT_RIGHT_BOTTOM = TILESIDE_LEFT | TILESIDE_RIGHT | TILESIDE_BOTTOM,
...
#define BASE_PRIORITY_PER_LAYER 32
#define MAX_PRIORITY_PER_LAYER 256
