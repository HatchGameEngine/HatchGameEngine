...
public:
	...
	void ForAll(void (*forFunc)(Uint32, T)) { ForAllOrdered(forFunc); }

	void WithAll(std::function<void(Uint32, T)> withFunc) { WithAllOrdered(withFunc); }
