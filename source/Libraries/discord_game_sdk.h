...
struct IDiscordLobbyTransaction {
	enum EDiscordResult(DISCORD_API* set_type)(
		struct IDiscordLobbyTransaction* lobby_transaction,
		enum EDiscordLobbyType type);
	enum EDiscordResult(DISCORD_API* set_owner)(
		struct IDiscordLobbyTransaction* lobby_transaction,
		DiscordUserId owner_id);
	...
	enum EDiscordResult(DISCORD_API* delete_metadata)(
		struct IDiscordLobbyTransaction* lobby_transaction,
		DiscordMetadataKey key);
	enum EDiscordResult(DISCORD_API* set_locked)(
		struct IDiscordLobbyTransaction* lobby_transaction,
		bool locked);
};
...
struct IDiscordLobbySearchQuery {
	enum EDiscordResult(DISCORD_API* filter)(
	...
	enum EDiscordResult(DISCORD_API* limit)(struct IDiscordLobbySearchQuery* lobby_search_query,
		uint32_t limit);
	enum EDiscordResult(DISCORD_API* distance)(
		struct IDiscordLobbySearchQuery* lobby_search_query,
...
struct IDiscordApplicationManager {
	...
	void(DISCORD_API* get_oauth2_token)(struct IDiscordApplicationManager* manager,
		void* callback_data,
...
struct IDiscordRelationshipManager {
	void(DISCORD_API* filter)(struct IDiscordRelationshipManager* manager,
		...
		bool(DISCORD_API* filter)(void* filter_data,
			struct DiscordRelationship* relationship));
	enum EDiscordResult(
		DISCORD_API* count)(struct IDiscordRelationshipManager* manager, int32_t* count);
...
struct IDiscordLobbyManager {
	...
	enum EDiscordResult(DISCORD_API* get_lobby_activity_secret)(
		...
		DiscordLobbyId lobby_id,
		DiscordLobbySecret* secret);
	enum EDiscordResult(DISCORD_API* get_lobby_metadata_value)(
		struct IDiscordLobbyManager* manager,
		DiscordLobbyId lobby_id,
		DiscordMetadataKey key,
		DiscordMetadataValue* value);
	enum EDiscordResult(DISCORD_API* get_lobby_metadata_key)(
		struct IDiscordLobbyManager* manager,
		DiscordLobbyId lobby_id,
		int32_t index,
		DiscordMetadataKey* key);
	...
	enum EDiscordResult(DISCORD_API* get_member_metadata_value)(
		...
		DiscordMetadataKey key,
		DiscordMetadataValue* value);
	enum EDiscordResult(DISCORD_API* get_member_metadata_key)(
		struct IDiscordLobbyManager* manager,
		DiscordLobbyId lobby_id,
		DiscordUserId user_id,
		int32_t index,
		DiscordMetadataKey* key);
	enum EDiscordResult(DISCORD_API* member_metadata_count)(
		struct IDiscordLobbyManager* manager,
		DiscordLobbyId lobby_id,
		DiscordUserId user_id,
		int32_t* count);
...
struct IDiscordOverlayManager {
	...
	void(DISCORD_API* set_ime_selection_bounds_callback)(struct IDiscordOverlayManager* manager,
		...
		void(DISCORD_API* on_ime_selection_bounds_changed)(
			void* on_ime_selection_bounds_changed_data,
...
struct IDiscordStorageManager {
	...
	void(DISCORD_API* write_async)(struct IDiscordStorageManager* manager,
		...
		void(DISCORD_API* callback)(void* callback_data, enum EDiscordResult result));
	enum EDiscordResult(
		DISCORD_API* delete_)(struct IDiscordStorageManager* manager, const char* name);
	...
	enum EDiscordResult(DISCORD_API* stat_at)(struct IDiscordStorageManager* manager,
		...
		struct DiscordFileStat* stat);
	enum EDiscordResult(
		DISCORD_API* get_path)(struct IDiscordStorageManager* manager, DiscordPath* path);
};
...
struct IDiscordVoiceManager {
	...
	void(DISCORD_API* set_input_mode)(struct IDiscordVoiceManager* manager,
		...
		void(DISCORD_API* callback)(void* callback_data, enum EDiscordResult result));
	enum EDiscordResult(
		DISCORD_API* is_self_mute)(struct IDiscordVoiceManager* manager, bool* mute);
	enum EDiscordResult(
		DISCORD_API* set_self_mute)(struct IDiscordVoiceManager* manager, bool mute);
	enum EDiscordResult(
		DISCORD_API* is_self_deaf)(struct IDiscordVoiceManager* manager, bool* deaf);
	enum EDiscordResult(
		DISCORD_API* set_self_deaf)(struct IDiscordVoiceManager* manager, bool deaf);
...
struct IDiscordCore {
	...
	struct IDiscordActivityManager*(DISCORD_API* get_activity_manager)(
		struct IDiscordCore* core);
