...
public:
	...
	static char* EndsWith(const char* string, const char* compare);
	static char* EndsWithCaseInsensitive(const char* string, const char* compare);
	...
	static bool ToNumber(int* dst, const char* src, int base = 10);
	static bool ToDecimal(double* dst, const char* src);
	static bool ToNumber(int* dst, std::string src, int base = 10);
	static bool ToDecimal(double* dst, std::string src);
	static bool OctalToBase10(size_t* dst, const char* src);
