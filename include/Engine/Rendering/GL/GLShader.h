...
#define UNIFORM_NUMPALETTECOLORS "u_numTexturePaletteIndices"
...
#define SHADER_FEATURE_FILTER_BW (1 << 6)
#define SHADER_FEATURE_FILTER_INVERT (1 << 7)
#define SHADER_FEATURE_TINTING (1 << 8)
#define SHADER_FEATURE_TINT_DEST (1 << 9)
#define SHADER_FEATURE_TINT_BLEND (1 << 10)
...
#define SHADER_FEATURE_ALL_MASK ((1 << 11) - 1)
