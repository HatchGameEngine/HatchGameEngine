...
#define VM_ADD_OPFUNC(op) int OPFUNC_##op(CallFrame* frame)
	...
	VM_ADD_OPFUNC(OP_CAST_AS_INTEGER);
	VM_ADD_OPFUNC(OP_CAST_AS_DECIMAL);
	VM_ADD_OPFUNC(OP_LENGTH);
	VM_ADD_OPFUNC(OP_LOAD_RESOURCE);
	VM_ADD_OPFUNC(OP_CHECK_RESOURCE);
	VM_ADD_OPFUNC(OP_OPEN_RESOURCE_STREAM);
#endif
};
