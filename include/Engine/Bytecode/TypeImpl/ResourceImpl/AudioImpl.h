#ifndef ENGINE_BYTECODE_TYPEIMPL_RESOURCEIMPL_AUDIOIMPL_H
#define ENGINE_BYTECODE_TYPEIMPL_RESOURCEIMPL_AUDIOIMPL_H
...
#endif /* ENGINE_BYTECODE_TYPEIMPL_RESOURCEIMPL_AUDIOIMPL_H */
