...
public:
	...
	static int LoadSpriteResource(Uint32 hash, int unloadPolicy);
	static int LoadImageResource(Uint32 hash, int unloadPolicy);
	static int LoadModelResource(Uint32 hash, int unloadPolicy);
	static int LoadMusicResource(Uint32 hash, int unloadPolicy);
	static int LoadSoundResource(Uint32 hash, int unloadPolicy);
	static int LoadVideoResource(Uint32 hash, int unloadPolicy);
	static MediaBag* LoadVideo(Stream* stream);
